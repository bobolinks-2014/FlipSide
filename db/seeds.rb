...
ArticleTag.create(article: boo_russia, tag: putin, sentiment_score: -0.9, relevance: 0.9)
ArticleTag.create(article: yay_russia, tag: russia, sentiment_score: 0.5, relevance: 0.8)

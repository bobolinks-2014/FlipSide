...
describe 'MyNoko' do
  ...
  it "parser will make 20 articles" do
  ...
  it "#world_news_parse will return an array length 20" do
    expect(MyNoko.world_news_parse("https://news.google.com/news/section?pz=1&cf=all&ned=us&topic=w").length).to eq(10)
  end

  it "#world_news_parse will return an array of strings" do
    expect(MyNoko.world_news_parse("https://news.google.com/news/section?pz=1&cf=all&ned=us&topic=w")[0]).to be_an_instance_of(String)
